  ...
  return (
    <section className="min-h-screen  w-full p-5 ">
      <div className="flex flex-col items-center justify-center py-16   bg-gradient-to-br from-[#050e2f] to-[#87237f] rounded-3xl">
        <div className=" w-3/4">
          <h1 className="text-6xl font-bold text-white">Code Mentor</h1>
          <h1 className="text-center text-2xl">by</h1>
          <h2 className="text-4xl font-bold text-right text-white uppercase">
            Divy Koushik Mishra
          </h2>
        </div>
      </div>
